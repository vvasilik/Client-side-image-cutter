...
var imageWrapper = document.querySelector('.image_wrapper');
var shiftCoefficient = {
  x: 0,
  y: 0
};
imageLoader.addEventListener('change', function () {
  try {
    var inputFiles = imageLoader.files;
    ...
    alert("Something went wrong ".concat(e));
  }
});
...
function crop() {
  ...
  var cropBoxStyles = cropBox.getBoundingClientRect();
  var imageWrapperStyles = imageWrapper.getBoundingClientRect();
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "56080" + '/');
